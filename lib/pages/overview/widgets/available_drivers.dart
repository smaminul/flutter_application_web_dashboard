        ...
        children: [
          ...
          DataTable2(
              ...
              rows: List<DataRow>.generate(
                  7,
                  (index) => DataRow(cells: [
                        DataCell(CustomText(color: lightGrey, text: "Santos Enoque", weight: FontWeight.normal, size: 16,)),
                         DataCell(CustomText(color: lightGrey, text: "New York City", weight: FontWeight.normal, size: 16,)),
                          DataCell(
                            Row(
                              mainAxisSize: MainAxisSize.min,
                              children:  [
                          ...
                          DataCell(
                            Container(
                              ...
                              child: CustomText(text: "Assign Delivery", 
