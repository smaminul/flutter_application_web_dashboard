        ...
        children: [
          ...
          DataTable2(
              ...
              rows: List<DataRow>.generate(
                  7,
                  (index) => DataRow(cells: [
                        DataCell(CustomText(color: lightGrey, text: "Michael David", weight: FontWeight.normal, size: 16,)),
                         DataCell(CustomText(color: lightGrey, text: "Los Angeles", weight: FontWeight.normal, size: 16,)),
                          DataCell(
                            Row(
                              mainAxisSize: MainAxisSize.min,
                              children:  [
                          ...
                          DataCell(
                            Container(
                              ...
                              child: CustomText(text: "Block Client", 
